/*
  ...
  - Added the required column `barcode` to the `Uniform` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "Uniform_barcode_key" ON "Uniform"("barcode");
